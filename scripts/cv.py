...
if Path("../outputs/log_cv.csv").exists() :
    ...
    log_df = pd.DataFrame({'run': [], 'models': [], 'rules': [], 
    'lm_accuracy': [], 'lm_precision': [], 'lm_recall': [], 'lm_ROCAUC': [], 'lm_f1': [], 'lm_CM': [],
    'mlv_accuracy': [], 'mlv_precision': [], 'mlv_recall': [], 'mlv_ROCAUC': [], 'mlv_f1': [], 'mlv_CM': []})
...
def cv(train_list, testdata, i, log_df) :
    ...
    ### update log.csv ###
    new_log = {'run': i, 'models': input_models, 'rules': input_rules, 
    'lm_accuracy': lm_metric_accuracy, 'lm_precision': lm_metric_precision, 'lm_recall': lm_metric_recall, 'lm_ROCAUC': lm_metric_recall, 'lm_f1': lm_f1, 'lm_CM': str(lm_metric_cm[0][0]) + "," + str(lm_metric_cm[0][1]) + "," + str(lm_metric_cm[1][0]) + "," + str(lm_metric_cm[1][1]),
    'mlv_accuracy': mlv_metric_accuracy, 'mlv_precision': mlv_metric_precision, 'mlv_recall': mlv_metric_recall, 'mlv_ROCAUC': mlv_metric_recall, 'mlv_f1': mlv_f1, 'mlv_CM': str(mlv_metric_cm[0][0]) + "," + str(mlv_metric_cm[0][1]) + "," + str(mlv_metric_cm[1][0]) + "," + str(mlv_metric_cm[1][1])}
